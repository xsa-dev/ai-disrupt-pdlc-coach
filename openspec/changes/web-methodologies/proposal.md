...
- Включить в MVP 12 подтверждённых whitepaper элементов:
  ...
  3. Adaptation vs Redesign;
  4. Agent Applicability Matrix;
  5. Mob Elaboration;
  6. SDD Cycle;
...
- Для каждого элемента показывать назначение, условия применения, входы, последовательность действий, выходной артефакт, Definition of Done, связанные антипаттерны и точную ссылку на раздел whitepaper.
